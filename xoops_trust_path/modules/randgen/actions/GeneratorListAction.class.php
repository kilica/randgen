...
/**
 * Randgen_GeneratorListAction
**/
class Randgen_GeneratorListAction extends Randgen_AbstractListAction
{
    ...
    **/
    ...
    {
        $render->setTemplateName($this->mAsset->mDirname . '_generator_list.html');
        ...
        $render->setAttribute('introduction', Randgen_Utils::getModuleConfig($this->mAsset->mDirname, 'introduction'));
    }
}
