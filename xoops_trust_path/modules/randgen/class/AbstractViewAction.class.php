...
/**
 * Randgen_AbstractViewAction
**/
abstract class Randgen_AbstractViewAction extends Randgen_AbstractAction
{
    ...
    **/
    ...
    {
        $this->mRoot->mController->executeRedirect($this->_getNextUri($this->_getConst('DATANAME'), 'list'), 1, _MD_RANDGEN_ERROR_CONTENT_IS_NOT_FOUND);
    }
}
