...
require_once RANDGEN_TRUST_PATH . '/class/AbstractAction.class.php';

define('RANDGEN_FRAME_PERFORM_SUCCESS', 1);
define('RANDGEN_FRAME_PERFORM_FAIL', 2);
define('RANDGEN_FRAME_INIT_SUCCESS', 3);

define('RANDGEN_FRAME_VIEW_NONE','none');
define('RANDGEN_FRAME_VIEW_SUCCESS','success');
define('RANDGEN_FRAME_VIEW_ERROR','error');
define('RANDGEN_FRAME_VIEW_INDEX','index');
define('RANDGEN_FRAME_VIEW_INPUT','input');
define('RANDGEN_FRAME_VIEW_PREVIEW','preview');
define('RANDGEN_FRAME_VIEW_CANCEL','cancel');

/**
 * Randgen_Module
**/
class Randgen_Module extends Legacy_ModuleAdapter
{
    public /*** string ***/ $mActionName = null;

    public /*** Randgen_AbstractAction ***/ $mAction = null;

    public /*** bool ***/ $mAdminFlag = false;

    public /*** Randgen_AssetManager ***/ $mAssetManager = null;
    ...
    protected /*** Enum[] ***/ $_mAllowViewNames = array(
        RANDGEN_FRAME_VIEW_NONE,
        RANDGEN_FRAME_VIEW_SUCCESS,
        RANDGEN_FRAME_VIEW_ERROR,
        RANDGEN_FRAME_VIEW_INDEX,
        RANDGEN_FRAME_VIEW_INPUT,
        RANDGEN_FRAME_VIEW_PREVIEW,
        RANDGEN_FRAME_VIEW_CANCEL
    );
    ...
    **/
    public function startup()
    {
        ...
        XCube_DelegateUtils::call('Module.randgen.Global.Event.GetAssetManager',new XCube_Ref($this->mAssetManager),$this->mXoopsModule->get('dirname'));
    ...
    **/
    private function _getDefaultActionName()
    {
        ...
        $dataname = isset($dataname) ? $dataname : 'Generator';
    ...
    **/
    public function getRenderSystemName()
    {
        ...
        if(!defined('RANDGEN_ADMIN_RENDER_REGISTED'))
        {
            define('RANDGEN_ADMIN_RENDER_REGISTED',true);
            $root =& XCube_Root::getSingleton();
            $root->overrideSiteConfig(
                array(
                    'RenderSystems' => array(
                        'Randgen_AdminRenderSystem' => 'Randgen_AdminRenderSystem'
                    ),
                    'Randgen_AdminRenderSystem' => array(
                        'root' => RANDGEN_TRUST_PATH,
                        'path' => '/admin/class/RandgenAdminRenderSystem.class.php',
                        'class' => 'Randgen_AdminRenderSystem'
                    )
                )
            );
        }

        return 'Randgen_AdminRenderSystem';
    }
    ...
    private function _createAction()
    {
        ...
        switch(true)
        {
            case file_exists(
                ...
                break;
            case file_exists(
                $path = RANDGEN_TRUST_PATH . '/' . $fileName
            ):
                break;
            default:
                return false;
        ...
        $className = 'Randgen_' . ($this->mAdminFlag ? 'Admin_' : '')
            . ucfirst($this->mActionName) . 'Action';
        if(class_exists($className))
        {
            $this->mAction = new $className();
        }
        if(!$this->mAction instanceof Randgen_AbstractAction)
        {
            return false;
        }
    ...
    **/
    ...
    {
        /**
         * Module.randgen.Global.Event.Exception.ActionNotFound
         *
         * @param    string    $dirname
         *
         * @return    void
        **/
        XCube_DelegateUtils::call('Module.randgen.Global.Event.Exception.ActionNotFound',$this->mAssetManager->mDirname);
        /**
    ...
    **/
    ...
    {
        /**
         * Module.randgen.Global.Event.Exception.Preparation
         *
         * @param    string    $dirname
         *
         * @return    void
        **/
        XCube_DelegateUtils::call('Module.randgen.Global.Event.Exception.Preparation',$this->mAssetManager->mDirname);
        /**
    ...
    **/
    ...
    {
        /**
         * Module.randgen.Global.Event.Exception.Permission
         *
         * @param    string    $dirname
         *
         * @return    void
        **/
        XCube_DelegateUtils::call('Module.randgen.Global.Event.Exception.Permission',$this->mAssetManager->mDirname);
        /**
        ...
        **/
        ...
        $root =& XCube_Root::getSingleton();
        $root->mController->executeRedirect(XOOPS_URL, 1, _MD_RANDGEN_ERROR_PERMISSION);
    }
}
