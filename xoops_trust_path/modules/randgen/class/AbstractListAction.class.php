...
/**
 * Randgen_AbstractListAction
**/
abstract class Randgen_AbstractListAction extends Randgen_AbstractAction
{
    public /*** XoopsSimpleObject[] ***/ $mObjects = null;

    public /*** Randgen_AbstractFilterForm ***/ $mFilter = null;
     ...
     * @param    void
     *
     * @return    Randgen_{Tablename}FilterForm
    **/
