...
/**
 * Randgen_AssetManager
**/
class Randgen_AssetManager
{
    public /*** string ***/ $mDirname = '';

    public /*** string ***/ $mTrustDirname = 'randgen';
    ...
    **/
     ...
     * @param   string  $dirname
     * 
     * @return  Randgen_AssetManager
    **/
    public function &getInstance(/*** string ***/ $dirname)
    {
        /**
         *  @var    Randgen_AssetManager[]
        **/
    ...
    **/
    ...
    {
        return RANDGEN_TRUST_PATH . ($isAdmin ? '/admin/' : '/');
    }
}
