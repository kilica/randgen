...
/**
 * Randgen_AbstractAction
**/
abstract class Randgen_AbstractAction
{
    public /*** XCube_Root ***/ $mRoot = null;

    public /*** Randgen_Module ***/ $mModule = null;

    public /*** Randgen_AssetManager ***/ $mAsset = null;
    ...
    **/
     ...
     * @param   void
     * 
     * @return  Randgen_{Tablename}Handler
    **/
    ...
    **/
    ...
    {
        $this->mAccessController['main'] = Randgen_Utils::getAccessControllerObject($this->mAsset->mDirname, $dataname);
    }
    /**
    ...
    **/
    ...
    {
        return RANDGEN_FRAME_VIEW_NONE;
    }
