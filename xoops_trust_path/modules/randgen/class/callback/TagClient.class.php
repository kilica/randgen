 ...
 * tag client delegate
**/
class Randgen_TagClientDelegate implements Legacy_iTagClientDelegate
{
    /**
     * getClientList
     *
    ...
    public static function getClientList(/*** mixed[] ***/ &$list, /*** string ***/ $tDirname)
    {
        ...
        foreach($dirnames as $dir){
            ...
            if(Randgen_Utils::getModuleConfig($dir, 'tag_dirname')==$tDirname){
                $list[] = array('dirname'=>$dir, 'dataname'=>'generator');
    ...
    public static function getClientData(/*** mixed ***/ &$list, /*** string ***/ $dirname, /*** string ***/ $dataname, /*** int[] ***/ $idList)
    {
        ...
        //setup client module info
        $cri = Randgen_Utils::getListCriteria($dirname);
