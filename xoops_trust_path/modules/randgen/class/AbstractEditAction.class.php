...
/**
 * Randgen_AbstractEditAction
**/
abstract class Randgen_AbstractEditAction extends Randgen_AbstractAction
{
    ...
    **/
    public function getDefaultView()
    {
        ...
        {
            return RANDGEN_FRAME_VIEW_ERROR;
        }
    
        $this->mActionForm->load($this->mObject);
    
        return RANDGEN_FRAME_VIEW_INPUT;
    }
    ...
    **/
    public function execute()
    {
        ...
        {
            return RANDGEN_FRAME_VIEW_CANCEL;
        }
    ...
    **/
    protected function _doExecute()
    {
        ...
        {
            return RANDGEN_FRAME_VIEW_SUCCESS;
        }
    ...
    **/
    ...
    {
        $this->mRoot->mController->executeRedirect($this->_getNextUri($this->_getConst('DATANAME')), 1, _MD_RANDGEN_ERROR_DBUPDATE_FAILED);
    }
