...
require_once RANDGEN_TRUST_PATH . '/class/AbstractAccessController.class.php';

/**
 * Randgen_GroupAccessController
**/
class Randgen_GroupAccessController extends Randgen_AbstractAccessController
{
    public $mType = 'group';
