...
define('RANDGEN_ADMIN_RENDER_TEMPLATE_DIRNAME','templates');
define('RANDGEN_ADMIN_RENDER_FALLBACK_PATH',XOOPS_MODULE_PATH . '/legacy/admin/theme');    // TODO will be use other path
define('RANDGEN_ADMIN_RENDER_FALLBACK_URL',XOOPS_MODULE_URL . '/legacy/admin/theme');    // TODO will be use other url

/**
 * Randgen_AdminRenderSystem
**/
class Randgen_AdminRenderSystem extends Legacy_AdminRenderSystem
{
    /**
     * prepare
     * 
    ...
    **/
    public function renderTheme(/*** XCube_RenderTarget ***/ &$target)
    {
        ...
        $info = Randgen_AdminRenderSystem::getOverrideFileInfo('admin_theme.html');
        $this->mSmarty->template_dir = ($info['file'] != null) ?
            substr($file['path'],0,-15) :
            RANDGEN_ADMIN_RENDER_FALLBACK_PATH;
    ...
    **/
    ...
    {
        $info = Randgen_AdminRenderSystem::getOverrideFileInfo($target->getTemplateName());
    ...
    **/
    public static function getOverrideFileInfo(/*** string ***/ $file,/*** string ***/ $prefix = null,/*** bool ***/ $isSpDirName = false)
    {
        ...
        {
            $handler =& Randgen_Utils::getXoopsHandler('module');
        ...
        switch(true)
        {
            ...
            case $isModule && file_exists(
                ...
                $ret['dirname'] = $trustDirName;
                return $ret;
            case file_exists($path = RANDGEN_ADMIN_RENDER_FALLBACK_PATH . '/' .$file):
                $ret['url'] = RANDGEN_ADMIN_RENDER_FALLBACK_URL . '/' . $file;
                $ret['path'] = $path;
                $ret['theme'] = null;
                $ret['dirname'] = null;
                return $ret;
    ...
    **/
    ...
    {
        $info = Randgen_AdminRenderSystem::getOverrideFileInfo($str);
        if($info['url'] != null)
        {
            return $info['url'];
        }
        return RANDGEN_ADMIN_RENDER_FALLBACK_URL . '/' . $str;
    }
    ...
    **/
    public static function functionStylesheet(/*** {string 'file',string 'media'} ***/ $param,/*** Smarty ***/ &$smarty)
    {
        ...
        $info = Randgen_AdminRenderSystem::getOverrideFileInfo($params['file'],'stylesheets/');
        if($info['file'] == null)
        {
            return;
        }
